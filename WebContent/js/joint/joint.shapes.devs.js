...
joint.shapes.devs.Model = joint.shapes.basic.TextBlock.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    ...
    getPortAttrs: function(portName, index, total, selector, type) {
        ...
        if (selector === '.outPorts') {
          attrs[portSelector] = { ref: '.body', 'ref-x': (index + 0.5) * (1 / total), 'ref-dy':0 };
        }
...
joint.shapes.devs.DialogueBox = joint.shapes.devs.Model.extend(joint.shapes.basic.TextBlock, joint.shapes.basic.TextBlock.prototype)
